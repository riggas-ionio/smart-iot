...
public class Aggregate{
    public Aggregate(String topic){
        ...
        KTable<String, Integer> countAndSumTable = groupedStream
            .aggregate(
                () -> 0, // initializer
                (aggKey, newValue, aggValue) -> { //adder
                    System.out.println("PrevValue: "+aggValue);
                    System.out.println("NewValue: " +newValue);
                    return new Integer(aggValue + newValue);
                },
